...
for run in range(n_runs):
    ...
    savestring = "data/rebuttal/error_s1_Reg3_" + str(n_inner_samples) +"_"+ str(n_outer_samples)+".pkl"
    pickle.dump(dataset, open(savestring, "wb"))
savestring2 = "data/rebuttal/error_s1_time3" + str(n_inner_samples) +"_"+ str(n_outer_samples)+".pkl"
