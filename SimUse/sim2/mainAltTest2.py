...
for run in range(n_runs):
    ...
    savestring = "data/rebuttal/errors2_Reg2_" + str(n_inner_samples)+"_"+ str(n_outer_samples)+".pkl"
    pickle.dump(dataset, open(savestring, "wb"))
savestring2 = "data/rebuttal/error_s1_time2" + str(n_inner_samples) +"_"+ str(n_outer_samples)+".pkl"
