...
for run in range(n_runs):
    ...
    savestring = "data/rebuttal/error_s3_Reg2_" + str(n_inner_samples) +"_"+ str(n_outer_samples)+".pkl"
    pickle.dump(dataset, open(savestring, "wb"))
savestring2 = "data/rebuttal/error_s3_time2" + str(n_inner_samples) +"_"+ str(n_outer_samples)+".pkl"
